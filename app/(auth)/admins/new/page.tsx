...
const createAdmin = (formData: FormData) => {
	return apiFetch("/admins", "POST", formData);
};
...
export default function CreateAdminPage() {
	...
	const mutation = useMutation({
		onMutate: () => {
			return toast.loading("Creating Admin...");
		},
		mutationFn: createAdmin,
		onSuccess: (data, variables, context) => {
			toast.success("Admin created successfully!", { id: context });
			...
			<div className='max-w-2xl mx-auto'>
				...
				<Card>
					<CardHeader className='text-center'>
						<CardTitle className='text-2xl font-bold text-gray-900'>Create New Admin</CardTitle>
						<CardDescription>Please fill in the admin&apos;s details below</CardDescription>
					</CardHeader>
					<CardContent>
